...
//   render() {
//     const {thumbList, randomImage, score, timeSeconds, gameOver} = this.state
//     const ImgUrl = randomImage.imageUrl
...
//           <ul className="nav-unordered-cont">
//             <li>
//               <img
//                 src="https://assets.ccbp.in/frontend/react-js/match-game-website-logo.png"
...
//                 className="timer-img"
//               />
//               <p className="time">{timeSeconds} sec</p>
//             </li>
//           </ul>
//         </nav>
...
//             <img src={ImgUrl} alt="match" className="random-image" />
...
//           </div>
//         ) : (
//           <div className="bg-score-container">
...
//                 YOUR SCORE <br /> <span className="num">{score}</span>
//               </p>
//               <button
//                 type="button"
